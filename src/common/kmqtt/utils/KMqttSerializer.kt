...
interface KMqttSerializer {
    fun toByteArray(): UByteArray

    fun size(): UInt = toByteArray().size.toUInt()

    fun ByteArrayOutputStream.wrapWithFixedHeader(packetType: PacketType, flag: Int): UByteArray {
        require(flag in 0..15)
        val result = ByteArrayOutputStream()
        val fixedHeader = ((packetType.value shl 4) and 0xF0) or flag
    ...
    fun KMqttProperties.serializeProperties(validProperties: List<Property>): UByteArray {
